...
export default function Login() {
    return (
        ...
        <div className="flex font-mono h-screen flex-col justify-center py-12 sm:px-6 bg-orange-50 lg:px-8">
          <div className="sm:mx-auto sm:w-full sm:max-w-md">
          {/* <h2 className="mt-6 text-center text-6xl font-bold text-orange-900">Ring II Project</h2> */}
